...
\begin{figure}[htbp]
    ...
    \caption{Representative fluid--solid interaction problem, where the subscript $F$ denotes fluid-domain quantities and the subscript $S$ denotes solid-domain quantities. Image adapted from \citet{Richter2012}. \hl{Update f to F and s to S}}
