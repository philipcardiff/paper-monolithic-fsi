...
\begin{figure}[htbp]
    ...
    \caption{Representative fluid--solid interaction problem, where the subscript $F$ denotes fluid-domain quantities and the subscript $S$ denotes solid-domain quantities. Image adapted from \citet{OneraWebsite,Richter2012}. \hl{Update f to F and s to S}}
...
$\bb{\sigma}_S$ is the true (Cauchy) stress tensor, and $\bb{f}_{b,S}$ is a body force
...
The true (Cauchy) stress $\bb{\sigma}_S$ is supplied by the chosen mechanical law.
...
\end{equation}
where $\bb{f}_{b,F}$ is a body force per unit mass. The use of a kinematic
...
This condition prevents slip, gap formation and overlap at the interface.
...
\begin{equation}
    \bb{t}_F
    =
    \hat{\bb{n}}_F \cdot \bb{\sigma}_F,
    \qquad
    \bb{t}_S
    =
    \hat{\bb{n}}_S \cdot \bb{\sigma}_S,
    \qquad
    \hat{\bb{n}}_F = -\hat{\bb{n}}_S .
\end{equation}
Equivalently,
\begin{equation}
    \hat{\bb{n}}_F \cdot \bb{\sigma}_F
