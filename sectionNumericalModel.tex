...
OpenFOAM-based finite-volume toolbox, with PETSc~\citep{PETSc} used for the
nonlinear and linear algebra operations. The coupled FSI algorithm is
implemented through a fluid--solid coupling interface, which calls separate
fluid and solid region models to evaluate the discrete equations and assemble
the approximate Jacobian blocks described in
