...
This Rhie-Chow-type stabilisation has been shown in \citet{Cardiff2026} to dissapear in the limit of mesh refinement atat a second-order rate.
...
physical pressure diffusion term. Algebraically, it approximates the pressure
coupling that would arise through the velocity block when the velocity is
eliminated from the coupled momentum--pressure system. This connection motivates
its use in the velocity--pressure split strategy discussed below.
