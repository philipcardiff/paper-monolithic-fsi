...
\end{equation}
where $\delta_f$ is the face normal-gradient coefficient (\hl{avoid the introduction of this and use d and n instead}), $\bb{\Gamma}_f$ is the interface face area vector, and $\bb{n}$ is the interface unit normal.
