...
\end{equation}
where $\bb{q}_f$ denotes the face value of $\bb{q}$. On internal faces, face values are in general obtained by interpolation from the adjacent cell centres \hl{we should mention diffusion operator compact discretisation}.
