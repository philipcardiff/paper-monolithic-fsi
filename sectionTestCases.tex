...
To efficiently and robustly attain the steady-state solution, the simuilation is advanced in time until a steady response is obtained, where a damping coefficient $c_d = 0.2$ s$^{-1}$ is employed in the solid. 
